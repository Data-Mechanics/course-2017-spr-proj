...
class assignBusYards(dml.Algorithm):
    ...
    def provenance(doc=prov.model.ProvDocument(), startTime=None, endTime=None):
        ...
        resource_assigned_students = doc.entity('dat:echogu_wei0496_wuhaoyu#assignBusYards', {'prov:label': 'assigned_students', prov.model.PROV_TYPE: 'ont:DataSet'})
        resource_buses = doc.entity('dat:echogu_wei0496_wuhaoyu#assignBusYards', {'prov:label': 'buses', prov.model.PROV_TYPE: 'ont:DataSet'})
        ...
        doc.usage(run_assignBusYards, resource_assigned_students, startTime, None, {prov.model.PROV_TYPE: 'ont:Computation'})
        ...
        bus_route = doc.entity('dat:echogu_wei0496_wuhaoyu#assignBusYards', {prov.model.PROV_LABEL: 'bus_route', prov.model.PROV_TYPE: 'ont:DataSet'})
        doc.wasAttributedTo(bus_route, this_script)
        doc.wasGeneratedBy(bus_route, run_assignBusYards, endTime)
        doc.wasDerivedFrom(bus_route, resource_assigned_students, run_assignBusYards, run_assignBusYards, run_assignBusYards)
