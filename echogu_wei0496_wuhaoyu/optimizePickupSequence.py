...
class optimizePickupSequence(dml.Algorithm):
    ...
    reads = ['echogu_wei0496_wuhaoyu.assigned_students', 'echogu_wei0496_wuhaoyu.buses']
    ...
    def provenance(doc=prov.model.ProvDocument(), startTime=None, endTime=None):
        ...
        doc.usage(run_optimizePickupSequence, assigned_students, startTime, None, {prov.model.PROV_TYPE: 'ont:Computation'})
        ...
        pickup_sequence = doc.entity('dat:echogu_wei0496_wuhaoyu#optimizePickupSequence', {prov.model.PROV_LABEL: 'pickup_sequence', prov.model.PROV_TYPE: 'ont:DataSet'})
        doc.wasAttributedTo(pickup_sequence, this_script)
        doc.wasGeneratedBy(pickup_sequence, run_optimizePickupSequence, endTime)
        doc.wasDerivedFrom(pickup_sequence, assigned_students, run_optimizePickupSequence, run_optimizePickupSequence, run_optimizePickupSequence)
