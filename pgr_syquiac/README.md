...
We then calculated the correlation coefficients correlation_checkups_hospital.py and in correlation_pools_obesity.py, using the following formula:
...
2. Run the setup file to import necessary databases and other dependencies
```shell
python3 setup.py
```
